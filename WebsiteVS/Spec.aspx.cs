...
public partial class Spec : System.Web.UI.Page
{
     ...
     protected void Button2_Click(object sender, EventArgs e)
    {
     ...
     {
         Response.Redirect("CardCare.aspx");
     }
     protected void Button7_Click(object sender, EventArgs e)
     {
         Response.Redirect("CancCare.aspx");
     }
     protected void Button8_Click(object sender, EventArgs e)
     {
         Response.Redirect("CritCare.aspx");
     }
     protected void Button9_Click(object sender, EventArgs e)
     {
         Response.Redirect("Neuro.aspx");
     }
     protected void Button10_Click(object sender, EventArgs e)
     {
         Response.Redirect("Neph.aspx");
     }
     protected void Button11_Click(object sender, EventArgs e)
     {
         Response.Redirect("Ortho.aspx");
     }
